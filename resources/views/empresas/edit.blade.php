...
@section('content_header')
    <h1 class="m-0 custom-heading">
        <i class="fas fa-edit"></i> Editar Empresa: {{ $empresa->nombre }}
    </h1>
@stop
        ...
        <div class="col-md-8 offset-md-2">
                    ...
                    <form action="{{ route('empresas.update', $empresa) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="dominio" id="dominio" class="form-control @error('dominio') is-invalid @enderror" value="{{ old('dominio', $empresa->dominio) }}" required placeholder="memiempresa">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">El email del administrador no se puede modificar.</small>
                        </div>

                        <div class="form-group">
                            <label for="password_admin">Nueva Contraseña del Administrador</label>
                            <input type="password" name="password_admin" id="password_admin" class="form-control @error('password_admin') is-invalid @enderror" placeholder="Dejar vacío para no cambiar">
                        ...
                        <div class="form-group">
                            <label for="password_admin_confirmation">Confirmar Nueva Contraseña</label>
                            <input type="password" name="password_admin_confirmation" id="password_admin_confirmation" class="form-control" placeholder="Repetir nueva contraseña">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @error('fecha_expiracion')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                            <small class="form-text text-muted">Dejar vacío para que no tenga expiración.</small>
                        </div>
            ...
            <div class="card mt-4">
                <div class="card-header">
                    <h5><i class="fas fa-database"></i> Información de la Base de Datos</h5>
                </div>
                <div class="card-body">
