                ...
                <form action="{{ route('producto.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="tab-content mt-3">
                        ...
                        <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                            <div class="row">
                                ...
                                <x-adminlte-input name="descripcion" label="Descripción"
                                    placeholder="{{ __('Ingresar descripción del producto') }}" fgroup-class="col-md-7" />
                                @error('descripcion')
                            ...
                            <div class="row">
                                <x-adminlte-select name="tipo" label="Tipo de Producto" fgroup-class="col-md-4"
                                    ...
                                    <option value="venta">{{ __('Para la Venta') }}</option>
                                    <option value="uso_interno">{{ __('Uso Interno') }}</option>
                        ...
                        <div class="tab-pane fade" id="comercial" role="tabpanel" aria-labelledby="comercial-tab">
                            ...
                            <div class="card card-outline card-info mt-3">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">{{ __('Define precios especiales según la cantidad comprada. El sistema usará automáticamente el tramo que corresponda.') }}</p>
                                    ...
                                    <small class="text-muted ml-2">{{ __('Ej: Desde 12 → 5.000, Desde 50 → 4.500') }}</small>
                                </div>
                            </div>
                        </div>
                        @endcan
                    ...
                    <div class="row mt-3">
                        <div class="form-group col-md-12 text-right">
                            <a class="btn btn-danger mx-1" href="{{ route('producto.index') }}">{{ __('Cancelar') }}</a>
