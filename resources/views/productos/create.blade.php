...
@section('content_header')
    <h1 class="m-0 custom-heading">{{ __('Registrar Producto') }}</h1>
@stop
                        ...
                        <div class="tab-pane fade show active"
                            ...
                            <div class="row">
                                <x-adminlte-input name="codigo"
                                                  ...
                                                  value="{{ old('codigo', generarcodigo()) }}"
                                ...
                                <x-adminlte-input name="descripcion"
                                                  label="Descripción"
                                                  placeholder="{{ __('Ingresar descripción del producto') }}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <button type="button"
                                            ...
                                            <i class="fas fa-times"></i> {{ __('Quitar imagen') }}
                                        </button>
                                    </div>
                                </div>
                                    ...
                                    <x-adminlte-select2 name="id_proveedor"
                                        ...
                                        @foreach ($proveedores as $prov)
                                            <option value="{{ $prov->id }}"
                                                {{ old('id_proveedor') == $prov->id ? 'selected' : '' }}>
                                                {{ $prov->razonsocial }}
                                            </option>
                                        @endforeach
                                    </x-adminlte-select2>
                            ...
                            <div class="row">
                                <x-adminlte-select2 name="id_categoria"
                                    ...
                                    @foreach ($categoria as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('id_categoria') == $item->id ? 'selected' : '' }}>
                                            {{ $item->descripcion }}
                                        </option>
                                    @endforeach
                                </x-adminlte-select2>
                                ...
                                <x-adminlte-select2 name="id_medida"
                                    ...
                                    @foreach ($medida as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('id_medida') == $item->id ? 'selected' : '' }}>
                                            {{ $item->descripcion }}
                                        </option>
                                    @endforeach
                                </x-adminlte-select2>
                            ...
                            <div class="row">
                                <x-adminlte-select name="tipo"
                                    ...
                                    <option value="venta" {{ old('tipo', 'venta') == 'venta' ? 'selected' : '' }}>
                                        {{ __('Para la Venta') }}
                                    </option>
                                    <option value="uso_interno" {{ old('tipo') == 'uso_interno' ? 'selected' : '' }}>
                                        {{ __('Uso Interno') }}
                                    </option>
                                    <option value="ambos" {{ old('tipo') == 'ambos' ? 'selected' : '' }}>
                                        {{ __('Ambos') }}
                                    </option>
                                </x-adminlte-select>
                            </div>
                        ...
                        @can('producto comercial')
                            ...
                            <div class="tab-pane fade"
                                ...
                                <div class="card card-outline card-info mt-3">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted">
                                            {{ __('Define precios especiales según la cantidad comprada. El sistema usará automáticamente el tramo que corresponda.') }}
                                        </p>
                                        ...
                                        <table class="table table-sm table-bordered" id="tierTable">
                                            ...
                                            <tbody id="tierBody">
                                                @if (old('tier_cantidad'))
                                                    @foreach (old('tier_cantidad') as $i => $cantidad)
                                                        <tr>
                                        ...
                                        <small class="text-muted ml-2">
                                            {{ __('Ej: Desde 12 → 5.000, Desde 50 → 4.500') }}
                                        </small>
                                    </div>
                                </div>
                            </div>
