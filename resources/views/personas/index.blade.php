...
@section('content_header')
    <div class="row">
        <div class="col-6">
            <h1 class="m-0 custom-heading">{{ __('Personas Receptoras') }}</h1>
        </div>
        <div class="col-6">
            <a href="{{ route('persona.create') }}" class="btn btn-primary" style="float: right;">{{ __('Registrar Nueva Persona') }}</a>
        </div>
    </div>
@stop
                        ...
                        @foreach ($personas as $row)
                            <tr>
                                ...
                                <td style="float:right;">
                                    <a href="{{ route('persona.edit', $row->id) }}" class="btn btn-outline-secondary"><i
