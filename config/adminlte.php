...
// $ventas=$controlador->verificaModelo('Ventas');
// //$ventas = [];
...
return [
        ...
        'Select2' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '/vendor/select2/select2.min.js', // Ruta local al archivo JS
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => '/vendor/select2/select2.css', // Ruta local al archivo CSS
                ],
            ],
        ],
        ...
        'guardaryborrar' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/mijs/guardaryborrar.js',
                ],
            ],
        ],
    ],
    ...
    */
    ...
    'livewire' => false, //activar para que funcione livewire | instalacion composer require livewire/livewire
];
